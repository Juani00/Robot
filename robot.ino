...
void setup() {
  ...
  // hidupkan lampu led merah, sebelum 2 mata bergerak ke arah hidung & keduanya berlawanan arah (satu kanan, satu kri)
  digitalWrite(ledPinRed, HIGH);
  moveEyesToDifferentPosition();

  // matikan lampu led merah.
...
void loop() {
    ...
    // * posisi mata telah berada di tengah **
